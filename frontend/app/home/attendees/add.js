...
import {  CREATE_ATTENDEE, UPLOAD_FILE } from './../../../services/queries';
...
export default function Page() {
    ...
    const formSubmit = (formData) => {
        ...
        handleCreateAttendee(attendeeData);
    }

    const [createAttendee] = useMutation(CREATE_ATTENDEE);
    ...
    const handleCreateAttendee = async (attendeeData) => {
        try {
            ...
            if (result.data.createAttendee.attendee_id) {    
